    ...
    try {
      ...
      try {
        ...
        if (!secretaryError && secretaries?.length) {
          ...
          const message = `TTruck: Waste collection has been recorded successfully. Barangay: ${barangayName}. Truck: ${truckCode}. Date: ${collectionDate}. Weight: ${weightValue} tons.\n\n - Track the Truck`;
